...
class Profile
{
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces([
            'Controller\Profile' => ROOT_PATH . '/modules/profile/controllers/',
        ], true);
    }
    ...
    public function registerServices($di)
    {
        ...
        $di['dispatcher'] = function () {
            ...
            $dispatcher->setDefaultNamespace('Controller\Profile');
        ...
        $di['view']->setViewsDir(ROOT_PATH . '/modules/profile/views/' . $defaultTemplate . '/');
    }
}
